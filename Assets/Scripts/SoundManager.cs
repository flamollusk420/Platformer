...
public class SoundManager : MonoBehaviour {
    public AudioClip PlayerJump, Dash, PlayerHit, PlayerMeleeHit, PlayerMelee, PlayerShoot, Parry, ParriedBulletHit, ParriedBulletDeath, BulletCollision, BulletDestroyedByDash, PlayerExplosion, PlayerFireWave, BothFireWavesDestroyed, PlayerHeal, PlayerDeath, EnemyDeath1, EnemyDeath2, EnemyDeath3, CommonCollectible, UncommonCollectible, CharmFound, StyleRankUp, PrimarySwap, Pause, Unpause, Menu1, Menu2;
